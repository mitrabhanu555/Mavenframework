...
public class FunctionLibrary {
	...
	public static WebDriver startBrowser() throws Throwable{
		...
		if (PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("chrome")){
			...
			System.setProperty("webdriver.chrome.driver", "D:\\Selenium-Evening\\Erp_Maven\\CommonDrivers\\chromedriver.exe");
	...
	public static void captureData(WebDriver driver,String locatortype,String locatorvalue) throws Throwable {
		...
		//write supplile number into notepad
		FileWriter fw = new FileWriter("D:\\Selenium-Evening\\Erp_Maven\\CaptureData\\supplier.txt");
	...
	public static void tableValidation(WebDriver driver,String testdata) throws Throwable{
		...
		FileReader fr = new FileReader("D:\\Selenium-Evening\\Erp_Maven\\CaptureData\\supplier.txt");
